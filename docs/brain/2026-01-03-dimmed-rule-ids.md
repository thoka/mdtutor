...
## Verification
- [ ] Run `sv check`.
- [ ] Verify that Rule IDs at the end of suite names and check names are displayed in gray/dimmed color in the terminal.

## Tasks
- [ ] Modify `severin/engine/lib/severin.rb`
- [ ] Verify with `sv check`
- [ ] Commit and ship
